...
```
cd existing_repo
git remote add origin https://gitlab.generalsoftwareinc.com/5g/aether.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.generalsoftwareinc.com/5g/aether/-/settings/integrations)
...
> > > > > > > # parent of 060ecbe (README.md fixed)
> > > > > > >
